...
//        /// </summary>
//        /// <value>True if the <see cref="Microsoft.AspNetCore.Mvc.ApiExplorerSettingsAttribute"/> is ignored; otherwise, false.
...
//        /// from the API explorer by setting <see cref="Microsoft.AspNetCore.Mvc.ApiExplorerSettingsAttribute.IgnoreApi"/>
//        /// to <c>true</c>. By setting this property to <c>false</c>, these settings are ignored instead of reapplying
//        /// <see cref="Microsoft.AspNetCore.Mvc.ApiExplorerSettingsAttribute.IgnoreApi"/> with a value of <c>false</c> to all OData controllers.</remarks>
...
//        public string RelatedEntityIdParameterDescription { get; set; } =
//            Microsoft.AspNetCore.Mvc.ApiExplorer.SR.RelatedEntityIdParamDesc;
