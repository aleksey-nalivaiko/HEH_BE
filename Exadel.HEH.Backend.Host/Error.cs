...
namespace Exadel.HEH.Backend.Host
{
    public static class Error
    {
        ...
        {
            return new ArgumentException(Error.Format("ArgumentInvalidHttpUriScheme", actualValue, HttpScheme, HttpsScheme), parameterName);
        }
        ...
        {
            return new ArgumentException(Error.Format("ArgumentUriHasQueryOrFragment", actualValue), parameterName);
        }
        ...
        {
            return Error.Argument(parameterName, "ArgumentNullOrEmpty", parameterName);
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("ArgumentMustBeGreaterThanOrEqualTo", minValue));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("ArgumentMustBeLessThanOrEqualTo", maxValue));
        }
