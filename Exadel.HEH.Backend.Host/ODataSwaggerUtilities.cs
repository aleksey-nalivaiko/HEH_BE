...
namespace Exadel.HEH.Backend.Host
{
    public static class ODataSwaggerUtilities
    {
        ...
        /// </summary>
        /// <param name="navigationSource">The Edm navigation source.</param>
        /// <returns>The <see cref="string"/> path represents the related Edm entity set.</returns>
        ...
        /// </summary>
        /// <param name="operationImport">The Edm operation import.</param>
        /// <returns>The <see cref="string"/> path represents the related Edm operation import.</returns>
